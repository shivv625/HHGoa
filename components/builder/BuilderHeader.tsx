  ...
  return (
    <header className="w-full bg-[#003F2D] border-b-[3px] border-[#F4D600] flex justify-center z-20 h-[84px] md:h-[84px]">
      <div className="w-full max-w-[1200px] px-6 py-4 flex justify-between items-center text-[#F4D600] mx-auto">
        ...
        <div className="flex items-center gap-8 font-mono text-[12px] tracking-widest font-bold uppercase">
          <Link href="/" className="hidden md:flex items-center gap-2 hover:text-white transition-colors text-[#F4D600]">
            <ArrowLeft size={14} /> HOME
          </Link>
          <div className="flex flex-col text-right text-[#F4D600] leading-none">
            <span className="text-[24px] font-black tracking-tighter">2:47<span className="text-[14px]">PM</span></span>
            <span className="text-[14px] tracking-widest font-black">STUDIO</span>
          </div>
        </div>
      </div>
    </header>
